...
public class TestGenerator
{
    ...
    public async Task<string> GenerateTestFromText(string text, int questionCount, string difficulty)
    {
        ...
        "Знизу під відповідями обовьязково пиши правильні відповіді. " +
        "Роби тестові завдання обовьязково лише в такому форматі : Які властивості визначають стандартні відступи та розміри боксів в CSS і як вони застосовуються?" +
