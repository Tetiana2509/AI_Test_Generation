        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FullTests_Topics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Topics",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_FullTests_FullTestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestResults_FullTests_FullTestId",
                        column: x => x.FullTestId,
                        principalTable: "FullTests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FullTests_TopicId",
                table: "FullTests",
                column: "TopicId");

            migrationBuilder.CreateIndex(
                name: "IX_Questions_FullTestId",
                table: "Questions",
                column: "FullTestId");

            migrationBuilder.CreateIndex(
                name: "IX_TestResults_FullTestId",
                table: "TestResults",
                column: "FullTestId");
